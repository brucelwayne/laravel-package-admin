                    ...
                    <form class="space-y-4 md:space-y-6" action="{{route('admin.attempt-login')}}" method="post">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between items-center space-x-2">
                                ...
                                <div class="w-1/2">
                                    <input type="text" name="captcha" id="captcha" placeholder="Anti-Spam Code" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                                </div>
                            </div>
                            @if($errors->has('captcha'))
                                <div class="error mt-2 text-sm text-red-600 dark:text-red-500">{{ $errors->first('captcha') }}</div>
                            @endif
                        </div>
                        ...
                        <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
                    </form>
                </div>
            </div>
        </div>
